      ...
      <div className="flex-1 p-6 space-y-6">
        ...
        <div className="grid grid-cols-12 gap-6 h-full">
          ...
          <div className="col-span-12 lg:col-span-9 flex flex-col gap-6">
            {/* Main Chart */}
            <Card className="bg-[#151921] border-white/10 p-4 flex flex-col min-h-[500px]">
          ...
          <div className="col-span-12 lg:col-span-3 flex flex-col gap-6">
            {/* Stock Info Panel */}
            <Card className="bg-[#151921] border-white/10 flex flex-col">
            ...
            {/* Related Industries (Radar Chart) - Now part of right sidebar */}
            <Card className="bg-[#151921] border-white/10 p-6 flex flex-col flex-1 min-h-[400px]">
               <div className="flex items-center gap-4 mb-6 border-b border-white/10 pb-2">
                  <div className="text-sm font-bold text-teal-400 border-b-2 border-teal-400 pb-2 -mb-2.5 px-1 cursor-pointer">관련 업종</div>
                  <div className="text-sm text-gray-500 pb-2 px-1 hover:text-white cursor-pointer transition-colors">공매도 현황</div>
                  <div className="text-sm text-gray-500 pb-2 px-1 hover:text-white cursor-pointer transition-colors">외국인/기관</div>
               </div>
